...
const Topup = ({ navigation, route }) => {
  const [state, setState] = useState(() => {
    return { whereNum: "", money: "", provider: route.params.name };
  });
      ...
      >
        <View style={styles.balanceView}>
          ...
          >
            ...
            <View style={styles.inputView}>
              <Text style={styles.inputLabel}>Số TK Nhà đầu tư</Text>
              <View
                style={[
                  styles.textInputView,
                  { backgroundColor: "#E7FFFC", marginTop: 5 },
              ...
              >
                ...
                />
                <TextInput
                  value={state.whereNum.toString()}
                  onChangeText={(e) => {
                    setState({ ...state, whereNum: e });
                  }}
                  placeholder="Nhập số TK Nhà đầu tư"
            ...
            <View style={styles.inputView}>
              <Text style={styles.inputLabel}>Số tiền đầu tư</Text>
              <View
                style={[
                  styles.textInputView,
                  { backgroundColor: "#E7FFFC", marginTop: 5 },
